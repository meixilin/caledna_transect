...
# this script allow one input on the id 
myid <- args[1]
...
# write out the data # stability test 
filename <- paste("deco_stab_", primer, txlevel, gfmethod, ntrees, abun, cutoff, droptopo, myid, sep = "_")
