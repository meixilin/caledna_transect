...
#                       nrow = 3, ncol = 4) 
allpp <- grid.arrange(pplist[[1]],pplist[[2]], ncol = 2) 
ggsave(filename = paste0(plotdir, "beta_diver_combined_ordination_", today, ".pdf"), plot = allpp, height = 4, width = 8)
# cleanup --------