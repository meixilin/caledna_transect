#!/bin/bash
#$ -N x5_step7_store_prediction_noextrap
#$ -l highp,highmem,exclusive,h_rt=05:00:00,h_data=240G,h_vmem=INFINITY
#$ -wd /u/project/rwayne/meixilin/caledna_transect
#$ -o /u/project/rwayne/meixilin/caledna_transect/derive_data/step7_gradient_forest_prediction/logs/5_step7_store_prediction_noextrap_20201019.out.txt
#$ -e /u/project/rwayne/meixilin/caledna_transect/derive_data/step7_gradient_forest_prediction/logs/5_step7_store_prediction_noextrap_20201019.err.txt
#$ -m abe

# @version 		v1
# @usage		qsub 5_step7_store_prediction_noextrap_qsub.sh
# @description	store as raster format on gradient forest predictions (WITHOUT EXTRAPOLATION)
...
LOG="${WORK}/derive_data/step7_gradient_forest_prediction/logs/5_step7_store_prediction_noextrap_20201019.log"
