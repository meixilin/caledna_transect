#! /bin/bash
#$ -N x1_step7_make_prediction_extrap
#$ -l h_rt=05:00:00,h_data=15G,h_vmem=20G
#$ -wd /u/project/rwayne/meixilin/caledna_transect
#$ -o /u/project/rwayne/meixilin/caledna_transect/derive_data/step7_gradient_forest_prediction/logs/1_step7_make_prediction_extrap_20201013.out.txt
#$ -e /u/project/rwayne/meixilin/caledna_transect/derive_data/step7_gradient_forest_prediction/logs/1_step7_make_prediction_extrap_20201013.err.txt
#$ -m abe

# @version 		v1
# @usage		qsub -t 1-51 1_step7_make_prediction_extrap_qsub.sh
# @description	generate gradient forest predictions (WITH EXTRAPOLATION)
...
LOG=${WORK}/derive_data/step7_gradient_forest_prediction/logs/1_step7_make_prediction_extrap_20201013_split${II}.log
# set parameters
extrap="TRUE"
