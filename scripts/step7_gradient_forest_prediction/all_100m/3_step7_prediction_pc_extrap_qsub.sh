#!/bin/bash
#$ -N x3_step7_prediction_pc_extrap
#$ -l highp,highmem,h_rt=23:00:00,h_data=90G,h_vmem=INFINITY
#$ -wd /u/project/rwayne/meixilin/caledna_transect
#$ -o /u/project/rwayne/meixilin/caledna_transect/derive_data/step7_gradient_forest_prediction/logs/3_step7_prediction_pc_extrap_20201018.out.txt
#$ -e /u/project/rwayne/meixilin/caledna_transect/derive_data/step7_gradient_forest_prediction/logs/3_step7_prediction_pc_extrap_20201018.err.txt
#$ -m abe

# @version 		v1
# @usage		qsub 3_step7_prediction_pc_extrap_qsub.sh
# @description	perform principal component analyses on gradient forest predictions (WITH EXTRAPOLATION)
...
Trns_site_filepath="${WORK}/derive_data/step7_gradient_forest_prediction/$gfname/extrap_$extrap/predict_gf_Trns_site_extrap.RData"
